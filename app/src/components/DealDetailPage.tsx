      ...
      <div className="neu-card p-6 md:p-8 space-y-6">
        ...
        {isInitiator && isDirectDeal && (
          <div className="neu-card p-5 rounded-3xl border border-slate-300/50 dark:border-slate-800/80 space-y-4 shadow-md bg-[#e4ebf5]/60 dark:bg-[#0d111a]/60">
            {/* Header */}
            <div className="flex items-center gap-2">
              <Link className="h-4 w-4 text-slate-700 dark:text-slate-200" />
              <h3 className="text-sm font-extrabold text-slate-900 dark:text-white tracking-wide">
                Payment link
              </h3>
            </div>

            {/* Read-Only Full Width Link Bar */}
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (link) {
                    ...
                    showNotice('Payment link copied to clipboard!');
                  }
                }}
        ...
        {!isDirectDeal && currentDeal.type === 'SERVICE_LISTING' && slotSubOrders.length > 0 && isInitiator && (
